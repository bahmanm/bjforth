...
class GTTest {
  ...
  @DisplayName(
      "pushes 1 if second top is greater than top of parameter stack, 0 otherwise, ie ab -> c where c=0 if !a>b and c=1 if a>b.")
  @ParameterizedTest(
      name =
  ...
  void worksOkWithNumbers(
    ...
    var state1 =
        aMachineState()
            ...
            .withMemory(aMemory().with(gtAddr, gt).build())
