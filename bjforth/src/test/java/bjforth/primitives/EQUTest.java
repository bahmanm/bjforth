...
class EQUTest {
  ...
  @DisplayName(
      "pushes 1 if top 2 are equal, 0 otherwise, ie ab -> c where c=0 if a!=b and c=1 if a==b.")
  @ParameterizedTest(
      name =
  ...
  void worksOkWithNumbers(
    ...
    // GIVEN
    var EQUaddr = getPrimitiveAddress("=");
    var actualState =
        aMachineState()
            .withInstrcutionPointer(EQUaddr)
            .withNextInstructionPointer(EQUaddr + 1)
      ...
      result.addAll(
          List.of(
              Arguments.of(
                  obj1,
                  obj2,
                  obj1.equals(obj2) ? 1 : 0,
                  Object.class.getCanonicalName(),
                  Object.class.getCanonicalName()),
              Arguments.of(
                  obj1,
                  obj1,
                  obj1.equals(obj1) ? 1 : 0,
                  Object.class.getCanonicalName(),
                  Object.class.getCanonicalName())));
      try {
        var file1 =
        ...
        result.addAll(
            List.of(
                Arguments.of(
                    file1,
                    file2,
                    file1.equals(file2) ? 1 : 0,
                    file1.getClass().getCanonicalName(),
                    file2.getClass().getCanonicalName()),
                Arguments.of(
                    file1,
                    file1,
                    file1.equals(file1) ? 1 : 0,
                    file1.getClass().getCanonicalName(),
                    file1.getClass().getCanonicalName()),
                Arguments.of(
                    file1,
                    obj1,
                    file1.equals(obj1) ? 1 : 0,
                    file1.getClass().getCanonicalName(),
