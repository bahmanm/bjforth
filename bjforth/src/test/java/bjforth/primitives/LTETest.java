...
class LTETest {
  ...
  @DisplayName(
      "pushes 1 if second top is less than or equal to the top of parameter stack, 0 otherwise, ie ab -> c where c=0 if a>b and c=1 if a<=b.")
  @ParameterizedTest(
      name =
  ...
  void worksOkWithNumbers(
    ...
    // GIVEN
    var LEaddr = BootstrapUtils.getPrimitiveAddress("<=");
    var actualState =
        aMachineState()
