...
public class COPY implements MachinePrimitiveWithNext {
  ...
  public void executeWithNext(Machine machine) {
    try {
      ...
      if (fromAddrObject instanceof Integer fromAddress
          && toAddrObject instanceof Integer toAddress) {
        var obj = machine.getMemoryAt(fromAddress);
        machine.setMemoryAt(toAddress, obj);
      } else {
