...
public class ADD implements MachinePrimitiveWithNext {

  private static final AddNumberFunction add = new AddNumberFunction();
  ...
  private static class AddNumberFunction extends AbstractBinaryNumberFunction<Number> {
